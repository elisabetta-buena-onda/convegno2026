...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-background-light font-display">
      ...
      <header
        className="relative flex items-end pb-12 md:pb-24 px-4 overflow-hidden bg-primary bg-cover bg-[position:70%_center] md:bg-top bg-no-repeat h-[60vh] md:h-[500px]"
        style={{ backgroundImage: "linear-gradient(to top, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.3) 50%, transparent 100%), url('/sfondo_convegno26.png')" }}
      >
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link href="/prenota" className="bg-white text-primary px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-slate-50 transition-all flex items-center justify-center gap-2 active:scale-95 hover:shadow-xl">
                <span>Clicca qui per prenotare</span>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12 text-center md:text-left">
            ...
            <p className="text-slate-500">Per acquistare una delle seguenti opzioni  clicca il pulsante in alto.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="group flex flex-col bg-slate-50 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-200">
              <div className="p-8 flex flex-col h-full bg-white">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Pernotto</h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-6 flex-1">
                  Pacchetto da 2 o 3 giorni in strutture convenzionate, complete di pass e pasti.
                </p>
                <div className="text-primary font-black text-2xl">da € 160 <span className="text-sm text-slate-400 font-normal">/adulto</span></div>
              </div>
            </div>
            ...
            <div className="group flex flex-col bg-slate-50 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-200">
              <div className="p-8 flex flex-col h-full bg-white">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Pass Evento</h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-6 flex-1">
                  A scelta tra pass online o in presenza
                </p>
            ...
            <div className="group flex flex-col bg-slate-50 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-200">
              <div className="p-8 flex flex-col h-full bg-white">
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-6 flex-1">
                  Se desideri prenotare esclusivamente il pranzo o la cena.
                </p>
                <div className="text-primary font-black text-2xl">€ 20 <span className="text-sm text-slate-400 font-normal">/pasto</span></div>
              </div>
            </div>
          </div>
        </div>
